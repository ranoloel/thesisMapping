...
def getFileListCustom(dirName):
    ...
    for entry in listOfFile:
        ...
        if os.path.isdir(fullPath):
            ...
            if entry.endswith(".JPG") or entry.endswith(".jpg") or entry.endswith(".png") or entry.endswith(".PNG")  or entry.endswith(".mp4") or entry.endswith(".MOV"):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="postfix",
        default="coral",
        help='Specify the postfix for images with bounding boxes. Default is "_coral"',
    )
    ...
    input_paths = getFileListCustom(FLAGS.input_path)

    # Split images and videos
    img_endings = (".jpg", ".jpeg", ".png", ".JPG")
    ...
    print("Input path: ", FLAGS.input_path)
