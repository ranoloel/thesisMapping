...
class ImageData(db.Model):
    ...
    Condidence = db.Column(db.String(50), nullable=False)
...
def delete_files():
    folder_path = r'C:\Users\Admin\Documents\TrainYourOwnYOLO\Data\Source_Images\Test_Images'
    try:
...
#from old working template
@app.route('/submit', methods=['POST'])
def submit():
    if request.method == 'POST':
        # Fetch JSON data from the API
        api_url = 'http://127.0.0.1:5001/api/contents'
